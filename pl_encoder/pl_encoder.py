...
from utils import Group, Encoder
...
# don't know what encoder_dims=256 for?
# don't know what num_heads=8 for?
class PointTransformer(nn.Module):
    def __init__(self, trans_dim=256, depth=12, drop_path_rate=0.1, num_heads=8, group_size=32, num_group=784, encoder_dims=256):
        ...
        self.course_group_divider = Group(num_group = self.num_group, group_size = self.group_size)
    ...
    def forward(self, pts):
        ...
        neighborhood, center = self.fine_group_divider(pts)
